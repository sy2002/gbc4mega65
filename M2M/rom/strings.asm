...
LOG_STR_DEPS    .ASCII_W "Configuration: Smart dependencies (OPTM_DEP): "
LOG_STR_MENUHGT .ASCII_P "Warning: config.vhd: The largest menu view "
                .ASCII_P "has more lines than the height of the menu "
                .ASCII_W "window (OPTM_DY): largest view height: " 
