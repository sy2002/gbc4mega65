...
* **LCD Emulation**: A color grading is applied that approximates how the
  colors looked on the historical LCD screen. It is based on the well-known
  color-correction used by MiSTer.
